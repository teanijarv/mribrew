...
wf_dir = os.path.join(cwd, 'wf') # '/proj/sens2023026/to8050an/wf/' # os.path.join(cwd, 'wf')
...
print(f'(b1) n subjects running: {len(subject_scan_list)}')

# Computational variables
processing_type = 'MultiProc' # or 'Linear'

# ACT parameters
n_tracks = 10000 #10000000
...
# ---------------------- DTI
    ...
    (datasource, dwi2tensor, [('dwi_mask_file', 'mask')]), # add
