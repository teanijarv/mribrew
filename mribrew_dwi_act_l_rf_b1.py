...
from mribrew.act_interface import ResponseMean, MRTransform, MTNormalise, Generate5tt, SIFT, SIFT2
...
n_cpus = 4 # number of nipype processes to run at the same time
...
# ---------------------- ANATOMICALLY CONSTRAINED TRACTOGRAPHY (ACT) - SIFT2
    ...
    (mrxform2_parc, tck2conn, [('out_file', 'in_parc')]),
...
if __name__ == '__main__':
    # Run ACT workflow
    #workflow.config['execution'] = {'profile': True}
